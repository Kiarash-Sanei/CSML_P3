section .text
    global TFM
    TFM: ; Transpose Float Matrix (rdi -> n, rsi -> m, rdx -> matrix1 pointer, rcx -> matrix2 pointer)
        push rbp
        mov rbp, rsp
        sub rsp, 32
        ...
        transpose_outer_loop:
            ...
            transpose_inner_loop:
                ...
                mov r14, [rdx + rax * 8]    ; Load element from matrix1[i][j]
                mov [rcx + rbx * 8], r14    ; Store in matrix2[j][i]
